@extends('layouts.app')
@section('title', 'Controlla la tua email')
...
<div class="min-h-screen bg-[#F8F6F1] flex items-center justify-center p-4">
  <div class="w-full max-w-sm text-center">
    ...
    <div class="bg-white border border-gray-200 p-8 shadow-sm">
      ...
      <h1 class="text-xl font-bold text-[#1A1A1A] mb-3">Controlla la tua email</h1>
      <p class="text-sm text-gray-500 leading-relaxed mb-6">
        Abbiamo inviato un link di attivazione al tuo indirizzo email.<br>
        Clicca sul link per attivare il tuo account e iniziare a leggere.
      </p>

      <div class="text-xs text-gray-400 bg-gray-50 border border-gray-200 rounded p-3 mb-6">
